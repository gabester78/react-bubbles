...
- [ ] Explain what a token is used for.
      To authorize the user so they may see protected pages.

- [ ] What steps can you take in your web apps to keep your data secure?
      By using protected routes.

- [ ] Describe how web servers work.
      Companies maintain servers for us to rent all over the world and use rather than maintaining our own machines.

- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.
      Create = axios.post, Read = axios.get, Update = axios.put, Delete = axios.delete
